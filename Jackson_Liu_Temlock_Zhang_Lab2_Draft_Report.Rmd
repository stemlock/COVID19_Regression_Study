...
# percentage varialbe re-scale to number_per_100k (need to double check where to put this part in EDA or model regression)
...
stargazer(model1, model2, model3a, type = "text", omit.stat = "f",
          se = list(se.model3),
