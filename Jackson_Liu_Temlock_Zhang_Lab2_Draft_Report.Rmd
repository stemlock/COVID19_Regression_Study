...
### CLM Assumptions Validation for Model 3:
...
From the Normal Q-Q plot below, the points generally stay close to the normal line, with the tails exhibit certain degree of skew. There is no significant evidence of concerning normality in the errros.
```{r}
plot(model3, which=2)
```
...
From the Cook's plot, there is no strong evidence of concerning outliers.
