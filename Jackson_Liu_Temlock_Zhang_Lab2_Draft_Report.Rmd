...
df<-df%>%
  rename(case_rate_100k = 'Case.Rate.per.100000',
         ...
         medical_expense = "Medicaid.Expenditures.as.a.Percent.of.Total.State.Expenditures.by.Fund",
  ...
  select(State, case_rate_100k, death_rate_100k,population_density, white_pct, black_pct, hispanic_pct, 
         ...
         population_2018, non_elderly_pre_existing, homeless, medical_expense, retail_recreation, transit)
