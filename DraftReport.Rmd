...
```{r}
df %>% 
  ggplot(aes(log(population_density), case_rate_100k, color = White...of.Total.Population)) + 
  geom_point() +   
  labs(
...
```{r}
df %>% 
  ggplot(aes(x = log(population_density), y = case_rate_100k, color = Percent.living.under.the.federal.poverty.line..2018.)) + 
  geom_point() +   
  labs(
    title = 'Relation of Case.Rate.per.100000 to Population Density', 
    x = 'log Population Density', 
...
```{r}
df %>% 
  ggplot(aes(x = Percent.living.under.the.federal.poverty.line..2018., y = case_rate_100k, color = log(population_density))) + 
  geom_point() +   
  labs(
...
```{r}
df %>% 
  ggplot(aes(X65., case_rate_100k, color = log(population_density))) + 
  geom_point() +   
  labs(
...
```{r}
df %>% 
  ggplot(aes(Percent.Unemployed..2018., case_rate_100k, color = log(population_density))) + 
  geom_point() +   
  labs(
...
```{r}
model2a <- lm(case_rate_100k ~ log(population_density)+ White...of.Total.Population, data = df)
...
$$
```{r}
model2a <- lm(case_rate_100k ~ log(population_density)+ I((White...of.Total.Population)^2), data = df)
coeftest(model2a, vcov = vcovHC)
```
$$
\begin{aligned}
...
$$
```{r}
model2a <- lm(case_rate_100k ~ I((White...of.Total.Population)^2), data = df)
coeftest(model2a, vcov = vcovHC)
```
...
```{r}
model2bi <- lm(case_rate_100k ~log(population_density)+ white_pct+Percent.living.under.the.federal.poverty.line..2018., data = df)
coeftest(model2bi, vcov = vcovHC)
```
...
$$
```{r}
model2bii <- lm(case_rate_100k ~log(population_density)+ I((White...of.Total.Population)^2) + Percent.living.under.the.federal.poverty.line..2018., data = df)
coeftest(model2bii, vcov = vcovHC)
```
$$
\begin{aligned}
...
$$
```{r}
model2biii <- lm(case_rate_100k ~ Percent.living.under.the.federal.poverty.line..2018., data = df)
coeftest(model2biii, vcov = vcovHC)
```
...
$$
```{r}
model2c <- lm(case_rate_100k ~log(population_density)+ I((White...of.Total.Population)^2) + Percent.Unemployed..2018., data = df)
...
$$
```{r}
model2c <- lm(case_rate_100k ~ Percent.Unemployed..2018., data = df)
coeftest(model2c, vcov = vcovHC)
```
...
$$
```{r}
model2d <- lm(case_rate_100k ~log(population_density)+ White...of.Total.Population+Percent.living.under.the.federal.poverty.line..2018.+X65., data = df)
...
$$
```{r}
model2d <- lm(case_rate_100k ~log(population_density)+ I((White...of.Total.Population)^2) + Percent.living.under.the.federal.poverty.line..2018.+X65., data = df)
coeftest(model2d, vcov = vcovHC)
```
...
$$
```{r}
model2d <- lm(case_rate_100k ~X65., data = df)
coeftest(model2d, vcov = vcovHC)
```
...
```{r}
model3a <- lm(case_rate_100k ~ log(population_density) + white_pct 
              + Percent.living.under.the.federal.poverty.line..2018.
...
model3b <- lm(case_rate_100k ~ close_period, data = df)
...
se.model2 = coeftest(model2bi, vcov = vcovHC)[ , "Std. Error"]
#se.model3 = coeftest(model2b, vcov = vcovHC)[ , "Std. Error"]
#se.model4 = coeftest(model2c, vcov = vcovHC)[ , "Std. Error"]
#se.model5 = coeftest(model2d, vcov = vcovHC)[ , "Std. Error"]
se.model6 = coeftest(model3a, vcov = vcovHC)[ , "Std. Error"]

stargazer(model1, model2bi, model3a, type = "text", omit.stat = "f",
          se = list(se.model6),
